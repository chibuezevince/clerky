...
class ClerkingAssistant implements Agent, Conversational, HasStructuredOutput, HasTools {
    ...
    public function instructions(): Stringable|string {
        ...
        - Let the questions be what a lay patient can understand since they are the people the questions you generate will be asked.
        ...
        - Again, generate questions specific for a particular sex and age, for example, there is no need for scrotum questins to be asked for the female sex and so on.
        - Questions should be sequential, if you ask a question, ask its follow up instantly to better understand the full scope of the question. Like for example, if you ask if a patient attended antenatal, also ask a follow up that depends on the trueness or falseness of the question. Always follow questions up till the parent is exhausted.
        ...
        5. Cover relevant domains where applicable: location(s), onset, duration, character, severity, aggravating/relieving factors, associated symptoms, relevant systemic review.
        ...
        12. However, present it to be like it is the doctor that is wording the question to the patient and not the patient reading it directly
        13. You will be given the patient's age and sex. Use these to filter questions appropriately:
            - Only generate questions that are clinically relevant for the given age. For example, do not ask about menstrual history for a 70-year-old, or birth history for a 40-year-old.
        ...
        No need to ask when the complaint began in the question given that it is always passed in to the prompt. Just do not generate the when did (complaint) start question.
    PROMPT;
    }
